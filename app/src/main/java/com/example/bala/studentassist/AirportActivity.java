...
public class AirportActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyPlace place = map.get(MyRequest.AIRPORT);
        this.place = place;
        ...
        if(place!=null) {
            name = (TextView) findViewById(R.id.detail_name_airport);
            name.setText(place.getName());

            rating = (TextView) findViewById(R.id.rating_airport);
            rating.setText("Rating : " + place.getRating());

            vicinity = (TextView) findViewById(R.id.vicinity_airport);
            vicinity.setText(place.getVicinity());

            imageView = (ImageView) findViewById(R.id.image_airport);
