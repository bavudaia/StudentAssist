...
public class CafeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyPlace place = map.get(MyRequest.CAFE);
        this.place = place;
        ...
        if(place!=null) {
            name = (TextView) findViewById(R.id.detail_name_cafe);
            name.setText(place.getName());

            rating = (TextView) findViewById(R.id.rating_cafe);
            rating.setText("Rating : " + place.getRating());

            vicinity = (TextView) findViewById(R.id.vicinity_cafe);
            vicinity.setText(place.getVicinity());

            imageView = (ImageView) findViewById(R.id.image_cafe);
