...
public class HospitalActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyPlace place = map.get(MyRequest.HOSPITAL);
        this.place = place;
        ...
        if(place!=null) {
            name = (TextView) findViewById(R.id.detail_name_hospital);
            name.setText(place.getName());

            rating = (TextView) findViewById(R.id.rating_hospital);
            rating.setText("Rating : " + place.getRating());

            vicinity = (TextView) findViewById(R.id.vicinity_hospital);
            vicinity.setText(place.getVicinity());

            imageView = (ImageView) findViewById(R.id.image_hospital);
