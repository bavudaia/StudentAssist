...
public class TrainStationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyPlace place = map.get(MyRequest.TRAIN_STATION);
        this.place = place;
        ...
        if(place!=null) {
            name = (TextView) findViewById(R.id.detail_name_train_station);
            name.setText(place.getName());

            rating = (TextView) findViewById(R.id.rating_train_station);
            rating.setText("Rating : " + place.getRating());

            vicinity = (TextView) findViewById(R.id.vicinity_train_station);
            vicinity.setText(place.getVicinity());

            imageView = (ImageView) findViewById(R.id.image_train_station);
